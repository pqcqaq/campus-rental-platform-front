    ...
    <view class="main">
      <div class="postList">
        <div v-for="item in postList" :key="item.id" class="postItem">
          <PostCard :postId="item.id || ''" :post="item" :handleAction="handleCollect"></PostCard>
        </div>
...
const handleCollect = (postId: string, action: boolean) => {
  console.log('handleCollect', postId, action)
}
</script>
